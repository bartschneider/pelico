...
declare module '$env/static/private' {
	...
	export const HOMELAB_IP: string;
	export const FPATH: string;
	export const NODE: string;
	export const NEXTCLOUD_USERNAME: string;
	...
	export const HOMELAB_PASSWORD: string;
	...
	export const NEXTCLOUD_PASSWORD: string;
	...
	export const NEXTCLOUD_URL: string;
