...
declare module '$env/static/private' {
	...
	export const PIPENV_IGNORE_VIRTUALENVS: string;
	...
	export const CLAUDE_CODE_MCP_CONFIG_PATH: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GIT_EDITOR: string;
		USER: string;
		PIPENV_IGNORE_VIRTUALENVS: string;
		NVM_DIR: string;
		COMMAND_MODE: string;
		...
		CLAUDE_CODE_MCP_CONFIG_PATH: string;
